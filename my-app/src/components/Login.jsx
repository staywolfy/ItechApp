...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://studentinfoapp.i-tech.net.in/login", {
        method: "POST",
      ...
      if (data.success) {
        // Savconsole user info or token here if needed
        console.log("Login successful:", data.user);
 navigate("/dashboard", { state: { user: data.user } }); // Redirect to dashboard on success
      } else {
